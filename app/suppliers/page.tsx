...
import { CheckCircle, DollarSign, Users, TrendingUp, Phone, MessageSquare } from "lucide-react"
...
const steps = [
  {
    ...
    description: "Reach out to discuss your fuel supply business and requirements.",
  },
  {
    step: 2,
    title: "Business Verification",
    description: "We'll verify your fuel supplier license, certifications, and credentials.",
  },
  {
    step: 3,
    title: "Get Listed",
    description: "Start connecting with buyers and grow your fuel distribution business.",
  },
]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Why List With Us?</h2>
      ...
      <section className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Start Supplying?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Contact our sales team today to learn how we can help grow your fuel distribution business.
          </p>
