...
import { Search, Filter, Phone, Mail, Star, MapPin, MessageSquare } from "lucide-react"
...
const dieselListings = [
  ...
  },
  {
    ...
    phone: "(555) 234-5678",
    email: "info@industrialdiesel.com",
  },
  {
    id: 3,
    ...
    phone: "(555) 345-6789",
    email: "contact@regionalenergy.com",
  },
  {
    id: 4,
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link href="/pricing">
                <Button variant="ghost">Live Pricing</Button>
              </Link>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-4">Browse Diesel Suppliers</h1>
            <p className="text-gray-600">Find verified diesel fuel suppliers in your area</p>
          </div>
          ...
          <div className="flex flex-wrap gap-2">
            {fuelGrades.map((grade) => (
              <Badge
                key={grade}
                variant={grade === "All Grades" ? "default" : "secondary"}
        ...
        <div className="text-center mt-12">
          <Card className="max-w-2xl mx-auto">
            <CardHeader>
              <CardTitle>Need Help Finding the Right Supplier?</CardTitle>
              <CardDescription>
                Our team can help you connect with verified diesel suppliers that meet your specific requirements.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/pricing">
                <Button variant="outline">View Live Pricing</Button>
              </Link>
            </CardContent>
          </Card>
        </div>
